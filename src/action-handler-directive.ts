...
customElements.define('action-handler-uv-index', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-uv-index')) {
    return body.querySelector('action-handler-uv-index') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-uv-index');
